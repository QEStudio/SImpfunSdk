# Unofficial Simpfun SDK

[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

Unofficial Simpfun API 的 Rust SDK，提供 API 封装、WebSocket 实时通信和事件轮询系统。
...
```toml
[dependencies]
simpfun-sdk = { git = "https://github.com/QEStudio/SimpfunSdk.git" }
tokio = { version = "1", features = ["rt-multi-thread", "macros"] }
```
或者具体版本提交id
```toml
[dependencies]
simpfun-sdk = { git = "https://github.com/QEStudio/SimpfunSdk.git", rev = "a1b2c3d" }
```
...
```rust
use simpfun::{SimpfunClient, SdkError};
...
```rust
use simpfun::{SimpfunClient, connect_ins_ws, WsEvent};
...
```rust
use simpfun::{SimpfunClient, EventManager, Event, PollingConfig};
...
```rust
use simpfun::{EventIntervals, PollingConfig};
