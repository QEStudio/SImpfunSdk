...
impl SimpfunClient {
    ...
    pub async fn ins_file_list(&self, id: i64, path: &str) -> Result<InsFileListResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/list?{}", self.base_url, id, qs);
        ...
        if fr.code != 200 {
            return Err(SdkError::Api { code: fr.code, msg: "获取文件列表失败".to_string() });
        }
        Ok(fr)
    }
    ...
    pub async fn ins_file_fetch(&self, id: i64, path: &str) -> Result<InsFileContentResponse, SdkError> {
        let headers = self.build_auth_headers()?;
        let qs = serde_urlencoded::to_string([("path", path)])?;
        let url = format!("{}/api/ins/{}/file/fetch?{}", self.base_url, id, qs);
        let resp = self.send_with_retry(|| self.http.get(url.clone()).headers(headers.clone())).await?;
        let cr: InsFileContentResponse = resp.json().await?;
        if cr.code != 200 {
            return Err(SdkError::Api { code: cr.code, msg: "获取文件内容失败".to_string() });
        }
        Ok(cr)
    }
    ...
    pub async fn ins_file_save(&self, id: i64, path: &str, content: &str) -> Result<SimpleMsgResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/save", self.base_url, id);
        let resp = self
    ...
    pub async fn ins_file_create(&self, id: i64, mode: &str, root: &str, name: &str) -> Result<SimpleMsgResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/create", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_rename(&self, id: i64, origin: &str, target: &str) -> Result<SimpleMsgResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/rename", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_delete(&self, id: i64, list: Vec<String>) -> Result<SimpleMsgResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/delete", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_archive(
        ...
        let url = format!("{}/api/ins/{}/file/archive", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_unarchive(
        ...
        let url = format!("{}/api/ins/{}/file/unarchive", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_paste(
        ...
        let url = format!("{}/api/ins/{}/file/paste", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
    ...
    pub async fn ins_file_copy(&self, id: i64, location: &str) -> Result<SimpleMsgResponse, SdkError> {
        ...
        let url = format!("{}/api/ins/{}/file/copy", self.base_url, id);
        let resp = self
            .send_with_retry(|| self.http.post(url.clone()).headers(headers.clone()).body(body.clone()))
            .await?;
        let sr: SimpleMsgResponse = resp.json().await?;
